...
<head>
    ...
    <title>Galeri Foto - SMAN 1 Bengkalis</title>
...
<body>
    ...
    <!-- PAGE HEADER -->
    <section class="page-header" style="background: linear-gradient(135deg, rgba(0,64,41,0.9), rgba(0,64,41,0.7)), url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1600'); background-size: cover; background-position: center; padding: 8rem 0; text-align: center; color: white;">
        <div class="container">
            <h1 style="font-size: 4rem; margin-bottom: 1rem;">Galeri Foto</h1>
            <p style="font-size: 1.8rem; opacity: 0.9;">Dokumentasi kegiatan dan momen bersejarah di SMAN 1 Bengkalis</p>
        </div>
    </section>

    <!-- GALLERY CONTENT -->
    <section class="programs-section" style="padding: 6rem 0;">
        <div class="container">
            <div class="achievements-grid">
                <?php
                $jumlahDataPerHalaman = 8;
                $query_count = mysqli_query($koneksi, "SELECT id FROM foto");
                ...
                $query = mysqli_query($koneksi, "SELECT * FROM foto ORDER BY id DESC LIMIT $start, $jumlahDataPerHalaman");
                if(mysqli_num_rows($query) > 0){
                    while($data = mysqli_fetch_array($query)){
                ?>
                <div class="achievement-card">
                    <div class="achievement-image">
                        <img src="uploads/<?php echo $data['file_foto']; ?>" alt="<?php echo $data['judul']; ?>">
                    </div>
                ...
                <?php 
                    ...
                    echo "<p style='text-align:center; font-size: 1.6rem;'>Belum ada foto.</p>";
                } 
                ?>
            </div>
