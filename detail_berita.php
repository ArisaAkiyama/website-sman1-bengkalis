...
if (!$data) { echo "Berita tidak ditemukan."; exit; }
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    ...
    <article class="detail-article">
        ...
        <div class="detail-meta">
            ...
            <span><i class="far fa-eye"></i> <?php echo $data['views'] ?? 0; ?> views</span>
        </div>
        <?php if($data['gambar']) { ?>
        ...
        <div style="text-align: center; margin-top: 4rem;">
            <a href="news.php" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali ke Berita</a>
        </div>
    </article>
